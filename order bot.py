...
reply_map = {}  # message_id (у владельца) -> id клиента
...
async def relay(message: types.Message):
    ...
    sent = await bot.send_message(OWNER_CHAT_ID, header + (message.text or "[не текстовое сообщение]"))
    reply_map[sent.message_id] = sender.id
